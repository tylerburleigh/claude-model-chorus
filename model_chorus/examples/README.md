...
1. **Explore Real Providers**: Check the `model_chorus/providers/` directory for actual provider implementations (Anthropic, OpenAI, Google)

2. **Try Built-in Workflows**: Explore the `model_chorus/workflows/` directory for production-ready workflows like ThinkDeep, Debug, and Consensus
