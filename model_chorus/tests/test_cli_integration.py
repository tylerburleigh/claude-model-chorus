...
class TestArgumentCommand:
    ...
    def test_argument_with_continuation(
        self, mock_workflow_class, mock_get_provider, cli_runner, mock_provider
    ):
        ...
        result = cli_runner.invoke(
            app, ["argument", "Continue analysis", "--continue", "thread-123"]
        )
    ...
    def test_argument_with_temperature(
        ...
        result = cli_runner.invoke(app, ["argument", "Test", "--temperature", "0.9"])
    ...
    def test_argument_verbose_mode(
        ...
        result = cli_runner.invoke(app, ["argument", "Test", "--verbose"])
    ...
    @patch("model_chorus.cli.main.get_provider_by_name")
    def test_argument_invalid_provider(self, mock_get_provider, cli_runner):
...
class TestIdeateCommand:
    ...
    def test_ideate_basic_invocation(
        ...
        result = cli_runner.invoke(app, ["ideate", "New features for task management"])
    ...
    def test_ideate_with_files(
        ...
        result = cli_runner.invoke(
            app, ["ideate", "Ideas based on context", "--file", str(temp_test_file)]
        )
    ...
    def test_thinkdeep_missing_legacy_file_warns_and_continues(
        ...
        result = cli_runner.invoke(
            ...
            [
                "thinkdeep",
                "--step",
                "Investigate legacy path failure",
                "--step-number",
                "1",
                "--total-steps",
                "1",
                ...
                "Reproduced error",
                "--files-checked",
                "src/claude_skills/sdd_toolkit/core/options.py",
                "--skip-provider-check",
            ],
        )
...
class TestErrorHandling:
    ...
    def test_keyboard_interrupt(
        ...
        result = cli_runner.invoke(app, ["argument", "Test"])
    ...
    def test_very_long_prompt(self, cli_runner):
        ...
        result = cli_runner.invoke(app, ["argument", long_prompt])
    ...
    def test_special_characters_in_prompt(
        ...
        result = cli_runner.invoke(app, ["argument", special_prompt])
