...
This module provides support for project-level configuration via .modelchorusrc files.
...
class ConfigLoader:
    ...
    CONFIG_FILENAMES = ['.modelchorusrc', '.modelchorusrc.yaml', '.modelchorusrc.yml', '.modelchorusrc.json']
    ...
    def find_config_file(self, start_path: Optional[Path] = None) -> Optional[Path]:
        """Find .modelchorusrc file by searching up from start_path.
