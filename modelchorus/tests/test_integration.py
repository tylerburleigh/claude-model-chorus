...
from modelchorus.providers.claude_provider import ClaudeProvider
...
class TestIntegration:
    ...
    async def test_end_to_end_consensus(self, mock_claude_response, mock_codex_response):
        ...
        with patch("modelchorus.providers.cli_provider.asyncio.create_subprocess_exec") as mock_exec:
            import json
