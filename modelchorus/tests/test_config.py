...
from modelchorus.core.config import (
    ConfigLoader,
    GenerationDefaults,
    WorkflowConfig,
    ModelChorusConfig,
...
class TestConfigLoader:
    ...
    def test_find_config_file_in_current_dir(self, tmp_path):
        """Test finding .modelchorusrc in current directory."""
        config_file = tmp_path / ".modelchorusrc"
    ...
    def test_find_config_file_in_parent_dir(self, tmp_path):
        """Test finding .modelchorusrc in parent directory."""
        config_file = tmp_path / ".modelchorusrc"
        config_file.write_text("default_provider: claude")
    ...
    def test_find_config_file_yaml_extension(self, tmp_path):
        """Test finding .modelchorusrc.yaml file."""
        config_file = tmp_path / ".modelchorusrc.yaml"
    ...
    def test_find_config_file_json_extension(self, tmp_path):
        """Test finding .modelchorusrc.json file."""
        config_file = tmp_path / ".modelchorusrc.json"
        config_file.write_text('{"default_provider": "gemini"}')
